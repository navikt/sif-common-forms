...
const utenlandsoppholdMessages = {
    nb: {
        ...
        'utenlandsoppholdForm.fom.dateHasNoValue': defaultValidationMessages.nb.dateHasNoValue,
        'utenlandsoppholdForm.fom.dateIsAfterMax': defaultValidationMessages.nb.dateIsAfterMax,
        'utenlandsoppholdForm.fom.dateIsBeforeMin': defaultValidationMessages.nb.dateIsBeforeMin,
        'utenlandsoppholdForm.fom.dateHasInvalidFormat': defaultValidationMessages.nb.dateHasInvalidFormat,
        'utenlandsoppholdForm.fom.fromDateIsAfterToDate': defaultValidationMessages.nb.fromDateIsAfterToDate,
        'utenlandsoppholdForm.tom.dateHasNoValue': defaultValidationMessages.nb.dateHasNoValue,
        'utenlandsoppholdForm.tom.dateIsAfterMax': defaultValidationMessages.nb.dateIsAfterMax,
        'utenlandsoppholdForm.tom.dateIsBeforeMin': defaultValidationMessages.nb.dateIsBeforeMin,
        'utenlandsoppholdForm.tom.dateHasInvalidFormat': defaultValidationMessages.nb.dateHasInvalidFormat,
        'utenlandsoppholdForm.tom.toDateIsBeforeFromDate': defaultValidationMessages.nb.dateHasInvalidFormat,
