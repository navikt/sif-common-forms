const opptjeningUtlandMessages = {
    nb: {
        ...
        'opptjeningUtland.form.oppdragsgiverType.spm': 'Hva jobbet du som?',
        'opptjeningUtland.form.oppdragsgiverType.FRILANSER': 'Frilanser',
        'opptjeningUtland.form.oppdragsgiverType.ARBEIDSTAKER': 'Arbeidstaker',
        ...
        'opptjeningUtlandForm.oppdragsgiverNavn.noValue': 'Du må skrive inn {oppdragsgiverType} navn.',
